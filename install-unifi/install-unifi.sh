...
UNIFI_SOFTWARE_URL="https://dl.ubnt.com/unifi/5.6.37/UniFi.unix.zip" 

# The rc script associated with this branch or fork:
RC_SCRIPT_URL="https://raw.githubusercontent.com/jjaszkowiak/unifi-pfsense/master/rc.d/unifi.sh"
